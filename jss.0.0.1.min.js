...
w3c:{style:"",js_style:b,trans_evt:"transitionend",anim_evt:"animationend"}},d,f,e;a=null;try{for(var g in b){f=b[g].style;e=b[g].js_style;d=document.createElement("div");d.setAttribute("style",f+c.prop+":"+c.val+";");if(e in d.style){a=b[g];break}d=null}}catch(h){}return a}function i(c,b){var b=b||"",a;if(!document.getElementById("app_stylesheet"))a=document.createElement("style"),a.id="app_stylesheet",a.type="text/css",document.getElementsByTagName("head")[0].appendChild(a);(a=document.getElementById("app_stylesheet").sheet)||
(a=document.styleSheets[document.styleSheets.length-1]);if(c)for(var d in c){var f="",e="",g;if(typeof c[d]==="object"){g=c[d];for(var h in g)e=g[h],e=e.replace(/_vendor_/ig,b),h=h.replace(/_vendor_/ig,b),f+=h+": "+e+"; "}else e=c[d],e=e.replace(/_vendor_/ig,b),f+=e;d=d.replace(/_vendor_/ig,b);try{a.insertRule?a.insertRule(d+" {"+f+"}",a.cssRules.length):a.addRule&&a.addRule(d,f,-1)}catch(i){}}}k.JSS={g:{},test:j,css:i,cssIf:function(c,b,a){a=c.else_css||a||"css"in c&&b;b=c.css||b;if(!c.prop||!c.val||
!b)return null;(c=j(c))?i(b,c.style):a&&i(a);return c}};var m=/-([a-z])/ig})(this);